  ...
  return (
    <>
      ...
      <div className='container'>
        <p className='content_paragraph'>Experience premium cricket gear and services at unbeatable prices with VJ Sports. Our fair pricing ensures you get unmatched quality without compromise, elevating your cricket game beyond expectations. Discover the value of excellence today with our top-tier products and services designed for every cricket enthusiast.</p>

          ...
          <div className={styles["team-card"]}>
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="100%">
                ...
                <defs>
                  <linearGradient id="a" gradientUnits="userSpaceOnUse" x1="0" x2="0" y1="0" y2="100%" gradientTransform="rotate(222,648,379)">
                    ...
                    <stop offset="1" stopColor="rgba(4, 193, 250, 0.732)"></stop>
                  </linearGradient>
            ...
            <div className={styles["team-card__avatar"]}>
              <svg viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg">
                <circle cx="64" cy="64" fill="rgba(4, 193, 250, 0.732)" r="60"></circle>
                <circle cx="64" cy="64" fill="rgba(36,43,46,0.8)" opacity=".4" r="48"></circle>
                ...
                <path d="m62.76 36.94c4.24 8.74 10.71 10.21 16.09 10.21h5" style={{ fill: "none", strokeLinecap: "round", stroke: "#fff", strokeMiterlimit: "10", strokeWidth: '2', opacity: .1 }}></path>
                <path d="m71 35c2.52 5.22 6.39 6.09 9.6 6.09h3" style={{ fill: "none", strokeLinecap: "round", stroke: "#fff", strokeMiterlimit: "10", strokeWidth: "2", opacity: .1 }}></path>
                <circle cx="76" cy="62.28" fill="#515570" r="3"></circle><circle cx="52" cy="62.28" fill="#515570" r="3"></circle>
                ...
                <g fill="none" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  <path d="m55 56h-9.25" opacity=".2" stroke="#515570" strokeWidth="2"></path>
                  <path d="m82 56h-9.25" opacity=".2" stroke="#515570" strokeWidth="2"></path>
                </g>
                <path d="m64 84c5 0 7-3 7-3h-14s2 3 7 3z" fill="#f85565" opacity=".4"></path>
                <path d="m65.07 78.93-.55.55a.73.73 0 0 1 -1 0l-.55-.55c-1.14-1.14-2.93-.93-4.27.47l-1.7 1.6h14l-1.66-1.6c-1.34-1.4-3.13-1.61-4.27-.47z" fill="rgba(36,43,46,0.8)"></path>
              </svg>
            </div>
            <div className={styles["team-card__title"]}>SHAAN SHAIKH</div>
            <div className={styles["team-card__subtitle"]}>COACH</div>
            <div className={styles["team-card__wrapper"]}>
              <button className={styles["team-card__btn"]}>Contact</button>
            </div>
          </div>
        </div>
      </div>
